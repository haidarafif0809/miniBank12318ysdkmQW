...
if (!$stmt) {
   ...
   $query1 = $db->query("SELECT * FROM tbs_penarikan WHERE session_id = '$session_id'");
    ...
    $query2 = $db->query("INSERT INTO detail_penarikan (no_faktur,keterangan,dari_akun,ke_akun,jumlah,tanggal,jam,user) VALUES ('$no_faktur','$data[keterangan]','$data[dari_akun]','$data[ke_akun]','$data[jumlah]','$data[tanggal]','$data[jam]','$data[user]')");
