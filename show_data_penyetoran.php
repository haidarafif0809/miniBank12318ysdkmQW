...
$sql = "SELECT km.petugas_edit,km.tanggal_edit,km.jam_edit,km.id, km.no_faktur, km.keterangan, km.ke_akun, km.jumlah, km.tanggal, km.jam, km.user, da.nama_daftar_akun ";
