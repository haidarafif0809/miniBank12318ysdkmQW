...
$select_one = $db->query("SELECT p.keterangan,p.jumlah, p.tanggal, p.jam, p.user, da.nama_daftar_akun FROM penarikan p INNER JOIN daftar_akun da ON p.dari_akun = da.kode_daftar_akun WHERE p.no_faktur = '$no_faktur'");
...
<br>
 ...
 <table>
  <tbody>
      ...
      <tr><td  width="25%"><font class="satu">Keterangan</font></td> <td> :&nbsp;</td> <td><font class="satu"> <?php echo $out_one['keterangan']; ?> </font></td></tr>
...
$perintah = $db->query("SELECT dp.keterangan,dp.no_faktur,dp.dari_akun,dp.ke_akun,dp.jumlah,dp.tanggal,dp.jam,dp.user,da.nama_daftar_akun,plg.nama_pelanggan,plg.kode_pelanggan FROM detail_penarikan dp INNER JOIN daftar_akun da ON dp.dari_akun = da.kode_daftar_akun INNER JOIN pelanggan plg ON dp.ke_akun = plg.id WHERE dp.no_faktur = '$no_faktur'");
...
div.mix {border-style: dotted dashed solid double;}
 ...
 <table>
  <tbody>
      ...
      <tr><td  width="50%"><font class="satu">Total Penarikan</font></td> <td> :&nbsp;</td> <td><font class="satu">Rp. <?php echo rp($out_one['jumlah']); ?></font>  </td></tr>
