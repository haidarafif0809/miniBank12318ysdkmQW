...
include 'db.php';
 ...
 $no_faktur = $_POST['no_faktur'];
    ...
    $perintah = $db->query("SELECT km.id, km.no_faktur, km.keterangan, km.ke_akun, km.dari_akun, km.jumlah, km.tanggal, km.jam, km.user, da.nama_daftar_akun,p.nama_pelanggan,p.kode_pelanggan FROM detail_penarikan km INNER JOIN daftar_akun da ON km.dari_akun = da.kode_daftar_akun INNER JOIN pelanggan p ON km.ke_akun = p.id WHERE no_faktur = '$no_faktur'");
