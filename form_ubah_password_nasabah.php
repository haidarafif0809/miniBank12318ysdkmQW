...
<form role="form" method="post">
					...
					<input type="text" name="username" id="username" value="<?php echo $_SESSION['nama_pelanggan']; ?>" placeholder="Username" class="form-control" readonly="">
					</div>
  ...
  $("#submit").click(function(){
    ...
    $.post("cek_password_user_nasabah.php",{username:username,password:password},function(data){
...
$(document).ready(function(){
  ...
  $("#ubah_password").click(function(){
    ...
    $.post("update_password_nasabah.php",{username:username,password_baru:password_baru},function(data){
